...
function(state)
    ...
    if shortcut_status then
        ...
        function()
            if pcall(menu.ref_by_command_name, menu.get_value(multiple_custom_command1)) and pcall(menu.ref_by_command_name, menu.get_value(multiple_custom_command2)) then
